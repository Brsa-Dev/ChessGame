...
# Émis quand le joueur atteint 0 HP — écouté par main.gd
signal mort
...
var inventaire      : Array[Item] = []   # Items actuellement possédés
...
# Appelée après TOUTE source de dégâts (attaque, sorts, DoT).
# -------------------------------------------------------
...
# -------------------------------------------------------
# Retourne la classe du joueur ("guerrier", "mage", "archer", "fripon").
# Détection via le resource_path du script — centralisée ici
# pour éviter la duplication dans hud_ui, shop_manager, renderer…
# -------------------------------------------------------
